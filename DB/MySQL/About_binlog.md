...
<font color="red">MySQL运行过程中千万不要骚操作修改index文件，避免出问题</font>
...
<font color="red">再强调，row记录的是每条记录的情况(每次操作的每个记录记下来)，而不是sql语句</font>
...
**解决**：
设置参数<font color="red">binlog_rows_query_log_events=1</font>  建议打开
